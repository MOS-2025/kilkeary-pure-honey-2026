...
- Section of the code were taken from the bootstrap 5.3 library and then modified and added to for the purpose of the project.
- I used 3wschool.com as a resource when review and developing code.
- The icons in the footer and the beekeeping classes cards were taken from Bootstrap library.
- I also used Traversy Media a resources for the project.
