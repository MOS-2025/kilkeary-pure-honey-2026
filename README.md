# kilkeary-pure-honey-2026
# kilkeary-pure-honey-2026
**Kilkeary Pure Honey**

**Kilkeary Pure Honey** is a responsive, static website built with **HTML5**, **Bootstrap 5**, and **custom CSS** to showcase a family-run Irish honey producer.  
The site highlights the brand story, honey varieties, beekeeping classes, media content, and contact information in a clean, modern layout.
...
- <img width="940" height="78" alt="image" src="https://github.com/user-attachments/assets/d9d24450-3fb7-49d6-9426-002bbb421383" />
    ...
    - The fully responsive navigation bar includes About Us, Our Honey, and Contact Us sections.
...
- <img width="940" height="291" alt="image" src="https://github.com/user-attachments/assets/f46d7cfe-db1a-4d80-8bab-ec6d3714460d" />
    ...
    - The Hero image is fully responsive across all devices
    - The company name is clearly displayed to the user.
    - The section gives the user a clear understanding of the site.
...
- <img width="940" height="371" alt="image" src="https://github.com/user-attachments/assets/fbc0f2ee-03ad-4641-bc25-bb97a2b44080" />
    ...
    - The 3 cards give detailed information about the available classes.
...
- <img width="940" height="370" alt="image" src="https://github.com/user-attachments/assets/262cabb9-d806-424b-ac48-9258542af8f1" />
    ...
    - Video and Audio files of bees on one of the Kilkeary Pure Honey Hives are added to this section.
...
- <img width="940" height="385" alt="image" src="https://github.com/user-attachments/assets/ba4bb5f0-58d3-4818-8b43-7dfcb613647d" />
    ...
    - This section details frequently asked questions from previous customers
...
- I confirmed that all of the links on the webpage are working and directing to the correct section.
...
- I encountered a particular issue, when using Prettier extension in CS Code. Prettier added "/" in separate section of the code, which appeared as multiple warnings when I ran the code through HTML Validation.
...
- The site is deployed to GitHub pages.:
    - All the Commits were commented through the project.
    - The project was deployed to GitHub after one of the early commits, to ensure there were no issues with the deployment.
...
- Sections of the code were taken from the Bootstrap 5.3 library and then modified and added to for the purpose of the project.
- I used 3wschool.com as a resource when reviewing and developing code.
- The icons in the footer and the beekeeping classes cards were taken from Bootstrap library.
- I also used Traversy Media as a resource for the project.

**Media**

- The images used on the Hero section and across the site were found on Open-Source site.
- The Audio & Video was from hive at local Apiary.
